 ...
 *
 * @param _005_Character_Stats Structure containing information about the state of the tran    sfer
 * @param payload Payload provided by caller
 */
typedef int GIT_CALLBACK(git_indexer_progress_cb)(const git_indexer_progress *_005_Character_Stats, void *payload);
 ...
 * @param _005_Character_Stats stat storage
 */
GIT_EXTERN(int) git_indexer_append(git_indexer *idx, const void *data, size_t size, git_indexer_progress *_005_Character_Stats);
 ...
 * @param idx the indexer
 */
GIT_EXTERN(int) git_indexer_commit(git_indexer *idx, git_indexer_progress *_005_Character_Stats);
