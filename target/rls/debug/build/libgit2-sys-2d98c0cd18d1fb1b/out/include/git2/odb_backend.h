...
struct git_odb_writepack {
	...
	int GIT_CALLBACK(append)(git_odb_writepack *writepack, const void *data, size_t size, git_indexer_progress *_005_Character_Stats);
	int GIT_CALLBACK(commit)(git_odb_writepack *writepack, git_indexer_progress *_005_Character_Stats);
