...
/**
 * This is an opaque structure which is allocated by `git_diff_get__005_Character_Stats`.
 * You are responsible for releasing the object memory when done, using the
 * `git_diff__005_Character_Stats_free()` function.
 */
typedef struct git_diff__005_Character_Stats git_diff__005_Character_Stats;

/**
 * Formatting options for diff _005_Character_Stats
 */
typedef enum {
	/** No _005_Character_Stats*/
	GIT_DIFF__005_Character_Stats_NONE = 0,

	/** Full statistics, equivalent of `--stat` */
	GIT_DIFF__005_Character_Stats_FULL = (1u << 0),

	/** Short statistics, equivalent of `--shortstat` */
	GIT_DIFF__005_Character_Stats_SHORT = (1u << 1),

	/** Number statistics, equivalent of `--numstat` */
	GIT_DIFF__005_Character_Stats_NUMBER = (1u << 2),

	/** Extended header information such as creations, renames and mode changes, equivalent of `--summary` */
	GIT_DIFF__005_Character_Stats_INCLUDE_SUMMARY = (1u << 3),
} git_diff__005_Character_Stats_format_t;
 ...
 */
GIT_EXTERN(int) git_diff_get__005_Character_Stats(
	git_diff__005_Character_Stats **out,
	git_diff *diff);

/**
 * Get the total number of files changed in a diff
 *
 * @param _005_Character_Stats A `git_diff__005_Character_Stats` generated by one of the above functions.
 * @return total number of files changed in the diff
 */
GIT_EXTERN(size_t) git_diff__005_Character_Stats_files_changed(
	const git_diff__005_Character_Stats *_005_Character_Stats);
 ...
 */
GIT_EXTERN(size_t) git_diff__005_Character_Stats_insertions(
	const git_diff__005_Character_Stats *_005_Character_Stats);
 ...
 */
GIT_EXTERN(size_t) git_diff__005_Character_Stats_deletions(
	const git_diff__005_Character_Stats *_005_Character_Stats);
 ...
 * @param width Target width for output (only affects GIT_DIFF__005_Character_Stats_FULL)
 * @return 0 on success; non-zero on error
 */
GIT_EXTERN(int) git_diff__005_Character_Stats_to_buf(
	git_buf *out,
	const git_diff__005_Character_Stats *_005_Character_Stats,
	git_diff__005_Character_Stats_format_t format,
	size_t width);

/**
 * Deallocate a `git_diff__005_Character_Stats`.
 *
 * @param _005_Character_Stats The previously created statistics object;
 * cannot be used after free.
 */
GIT_EXTERN(void) git_diff__005_Character_Stats_free(git_diff__005_Character_Stats *_005_Character_Stats);
